...
typedef enum _sai_object_type_extensions_t
{
    ...
    SAI_OBJECT_TYPE_OUTBOUND_ACL_STAGE1,

    SAI_OBJECT_TYPE_OUTBOUND_ACL_STAGE2,

    SAI_OBJECT_TYPE_OUTBOUND_ACL_STAGE3,
    ...
    SAI_OBJECT_TYPE_INBOUND_ACL_STAGE1,

    SAI_OBJECT_TYPE_INBOUND_ACL_STAGE2,

    SAI_OBJECT_TYPE_INBOUND_ACL_STAGE3,
